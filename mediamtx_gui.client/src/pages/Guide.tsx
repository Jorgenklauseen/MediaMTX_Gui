...
const streamSteps = [
  ...
  },
  {
    ...
    description:
      'Click "Start Streaming" in OBS. The stream will appear on the Dashboard. Finished recordings can be found under "Recordings" in the menu.',
    details: [
...
const viewSteps = [
  {
    ...
    images: [
      { src: "/pictures/get_streams_00.png", alt: "Screenshot: Get playback URL" },
    ],
  },
  {
    number: 2,
